...
ggplot(data=fromPy,aes(x=Overallscore,y=Demo_efa)) + geom_point() + theme_minimal() + labs(x="DemoIndex (original)", y="DemoIndex (cambiado)")
```

```{r}
ggplot(data=fromPy,aes(x=Total,y=Fragile_efa)) + geom_point() + theme_minimal() + labs(x="FragileIndex (original)", y="FragileIndex (efa)")
```
