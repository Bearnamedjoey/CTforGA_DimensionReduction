...
2.  Decide if **transformation** is needed: Take a look at the data ranges:

```{r exploreTypes, eval=TRUE}
summary(dataToCluster)
```

```{r boxplotStandardize1, eval=TRUE}
...
```{r plotcompare, eval=TRUE, fig.width=12}
library(ggpubr)
